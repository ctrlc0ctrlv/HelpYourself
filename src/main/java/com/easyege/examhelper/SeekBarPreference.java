...
public final class SeekBarPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/com.easyege.examhelper";
    ...
    private static final int DEFAULT_CURRENT_VALUE = 25;
    ...
    protected View onCreateDialogView() {
        ...
        ((TextView) view.findViewById(R.id.max_value)).setText(String.format(Locale.ENGLISH, "%d", mMaxValue));
        ...
        mValueText.setText(String.format(Locale.ENGLISH, "%d", mCurrentValue));
